...
public class User {
    ...
    @OneToMany(mappedBy = "user",
            ...
            orphanRemoval = true)
    @JsonIgnore
    private List<JobPreference> jobPreferences;
    ...
    public User(int userId, String fullName, String email, String password, String phone,
            String gender, LocalDate dob, String address, String degree,
            String college, double cgpa, int passedOutYear,
            String experience, String currentCompany,
            String projects, String certifications,
            String linkedin, String github, Role role) {
    ...
    public void setJobPreferences(List<JobPreference> jobPreferences) {
